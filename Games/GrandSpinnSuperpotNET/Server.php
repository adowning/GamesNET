                    ...
                    case 'spin':
                        ...
                        for ($i = 0; $i <= 2000; $i++) {
                            ...
                            if (isset($jackState) && $jackState['isJackPay']) {
                                $reels['reel1'][1] = $reels['reel1'][1] ?? '102';
                                $reels['reel2'][1] = $reels['reel2'][1] ?? '102';
                                $reels['reel3'][1] = $reels['reel3'][1] ?? '102';
                            } else if (($reels['reel1'][1] ?? null) == '102' && ($reels['reel2'][1] ?? null) == '102' && ($reels['reel3'][1] ?? null) == '102') {
                            }
                            $winLineCount = 0;
                            for ($k = 0; $k < $lines; $k++) {
                                $tmpStringWin = '';
                                for ($j = 0; $j < count($slotSettings->SymbolGame); $j++) {
                                    ...
                                    if ($csym == $scatter || !isset($slotSettings->Paytable['SYM_' . $csym])) {
                                        ...
                                        $s = [];
                                        $s[0] = $reels['reel1'][$linesId[$k][0] - 1] ?? '0';
                                        $s[1] = $reels['reel2'][$linesId[$k][1] - 1] ?? '0';
                                        $s[2] = $reels['reel3'][$linesId[$k][2] - 1] ?? '0';
                                        $s[3] = $reels['reel4'][$linesId[$k][3] - 1] ?? '0';
                                        $s[4] = $reels['reel5'][$linesId[$k][4] - 1] ?? '0';
                            ...
                            for ($r = 1; $r <= 5; $r++) {
                                for ($p = 0; $p <= 2; $p++) {
                                    if (($reels['reel' . $r][$p] ?? null) == $scatter) {
                                        $scattersCount++;
                        ...
                        $curReels .= ('&rs.i0.r.i0.overlay.i0.with=SYM' . ($reels['reel1'][0] ?? '0') . '&rs.i0.r.i0.overlay.i1.with=SYM' . ($reels['reel1'][1] ?? '0') . '&rs.i0.r.i0.overlay.i2.with=SYM' . ($reels['reel1'][2] ?? '0'));
                        $curReels .= ('&rs.i0.r.i1.overlay.i0.with=SYM' . ($reels['reel2'][0] ?? '0') . '&rs.i0.r.i1.overlay.i1.with=SYM' . ($reels['reel2'][1] ?? '0') . '&rs.i0.r.i1.overlay.i2.with=SYM' . ($reels['reel2'][2] ?? '0') . '');
                        $curReels .= ('&rs.i0.r.i2.overlay.i0.with=SYM' . ($reels['reel3'][0] ?? '0') . '&rs.i0.r.i2.overlay.i1.with=SYM' . ($reels['reel3'][1] ?? '0') . '&rs.i0.r.i2.overlay.i2.with=SYM' . ($reels['reel3'][2] ?? '0') . '');
                        $curReels .= ('&rs.i0.r.i0.overlay.i0.pos=' . ($reels['rps'][0][0] ?? rand(1, 50)));
                        $curReels .= ('&rs.i0.r.i0.overlay.i1.pos=' . ($reels['rps'][0][1] ?? rand(1, 50)));
                        $curReels .= ('&rs.i0.r.i0.overlay.i2.pos=' . ($reels['rps'][0][2] ?? rand(1, 50)));
                        $curReels .= ('&rs.i0.r.i1.overlay.i0.pos=' . ($reels['rps'][1][0] ?? rand(1, 50)));
                        $curReels .= ('&rs.i0.r.i1.overlay.i1.pos=' . ($reels['rps'][1][1] ?? rand(1, 50)));
                        $curReels .= ('&rs.i0.r.i1.overlay.i2.pos=' . ($reels['rps'][1][2] ?? rand(1, 50)));
                        $curReels .= ('&rs.i0.r.i2.overlay.i0.pos=' . ($reels['rps'][2][0] ?? rand(1, 50)));
                        $curReels .= ('&rs.i0.r.i2.overlay.i1.pos=' . ($reels['rps'][2][1] ?? rand(1, 50)));
                        $curReels .= ('&rs.i0.r.i2.overlay.i2.pos=' . ($reels['rps'][2][2] ?? rand(1, 50)));
                        if ($postData['slotEvent'] == 'nudge') {
                        ...
                        for ($r = 1; $r <= 3; $r++) {
                            ...
                            $reelPosition = $reels['rp'][$r - 1] ?? $reels['position'][$r - 1] ?? rand(1, 50);
                            $responseData['spin']['rs']['i0']['r']['i' . ($r - 1)]['overlay']['i0'] = [
                                'pos' => $reelPosition,
                                'with' => 'SYM' . ($reels['reel' . $r][0] ?? '0'),
                                'row' => 0
                            ];
                            $responseData['spin']['rs']['i0']['r']['i' . ($r - 1)]['overlay']['i1'] = [
                                'pos' => $reelPosition + 1,
                                'with' => 'SYM' . ($reels['reel' . $r][1] ?? '0'),
                                'row' => 1
                            ];
                            $responseData['spin']['rs']['i0']['r']['i' . ($r - 1)]['overlay']['i2'] = [
                                'pos' => $reelPosition + 2,
                                'with' => 'SYM' . ($reels['reel' . $r][2] ?? '0'),
                                'row' => 2
                            ];
                            $responseData['spin']['rs']['i0']['r']['i' . ($r - 1)]['pos'] = $reelPosition;
                            $responseData['spin']['rs']['i0']['r']['i' . ($r - 1)]['syms'] = 'SYM' . ($reels['reel' . $r][0] ?? '0') . '%2CSYM' . ($reels['reel' . $r][1] ?? '0') . '%2CSYM' . ($reels['reel' . $r][2] ?? '0') . '';
                        }
