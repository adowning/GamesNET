...
class SlotSettings extends BaseSlotSettings
    public function __construct(\$settings)
    {
        ...
        \$this->initGameSpecificData();
    }

    private function initGameSpecificData()
    {
        // Game-specific data initialization
        // This method should be overridden in child classes for specific game logic
    }
